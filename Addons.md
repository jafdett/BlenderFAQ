...
## Блокинг (драфт)
- WonderMesh - аддон, который позволяет создавать 3D-примитивы (плоскость, куб, окружность, сфера, цилиндр, конус, капсула, тор, резьба) с множеством настроек, которые -- и это очень важно! -- возможно менять даже после манипуляций с этими примитивами на уровне объекта (все стандартные трансформации + работа с аддонами). 
