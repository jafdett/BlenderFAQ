...
## Совместимость
> **ВАЖНО:** Аддоны имеют такую важную особенность, как совместимость с версиями Блендер! Это касается сторонних аддонов, т.е. аддонов, которые не входят в "коробку" с программой. Если вы перейдёте по ссылке для скачивания соответствующего аддона, то обязательно ознакомтесь с его описанием. Как правило, одним из первых пунктов будет указано, с камими версиями Блендер совместим этот аддон.
> Аддон может работать с версиями, не указанными в описании, но гарантировать стабильность правильность его функционирования никто не сможет. Использование несовместимых аддонов помжет повлечь сбои в работе программы и потерю данных!
