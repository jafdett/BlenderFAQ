...
На macOS: нажмите <kbd>command</kbd> + <kbd>control</kbd> + <kbd>shift</kbd> + <kbd>4</kbd> (область экрана сразу попадет в буфер обмена ) или <kbd>command</kbd> + <kbd>shit</kbd> + <kbd>3</kbd> или <kbd>4</kbd> (будет сохранен в файл).
